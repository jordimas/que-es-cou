...
- What to fetch
  ...
  - For world news, fetch 50 articles for at least 10 sites
  - For Catalan news, fetch 50 articles for at least 10 sites
    - Sources should be only media in Catalan language
    - Sources must include: Ara.cat, Vilaweb, www.laVanguardia.cat, NacióDigital, plus any other Catalan media 
- How
